...
<div className='mt-24'>
      ...
      {/* <div className='
        ...
        <div className='flex justify-center '>
          <ul className='flex justify-evenly'>
            <li className='py-3 px-6 border-2'>Home</li>
            <li className='py-3 px-6 border-2'>Services</li>
            <li className='py-3 px-6 border-2'>Rewards</li>
            <li className='py-3 px-6 border-2'>Profile</li>
          </ul>
        </div>
      </div> */}
    </div>
