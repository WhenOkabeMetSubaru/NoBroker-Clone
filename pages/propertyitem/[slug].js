...
const Slug = () => {
  ...
  return (
    <section className='mt-10'>
      ...
      <div className='cols2 flex justify-evenly'>
        <div className='area1 3/5 '>
          <div className='1box m-10  h-[320px] border-[1px] border-gray-300 bg-white shadow-sm'>
            <h1 className='text-xl font-semibold pl-10 pt-5'>OverView</h1>
            <h1 className='w-[155px] h-[3px] bg-red-600'></h1>
          ...
          <div className='2box bg-white border-[1px] border-gray-300 shadow-sm  m-10 h-[200px]'>
              <h1 className='text-xl ml-10 py-3'>NoBroker Services</h1>
              <h1 className='w-[200px] h-[3px] bg-red-600'></h1>
              <div>
          ...
          <div className='3box p-8 m-10  h-[300px]  border-[1px] border-grey-300 bg-white shadow-sm'>
              <h1 className='ml-5 mb-1 text-xl '>Description</h1>
              <h1 className='w-[155px] h-[3px] bg-red-600'></h1>
          ...
          <div className='4box bg-white border-[1px] p-5  border-gray-300 shadow-sm  m-10 h-[200px]'>
            <h1 className='text-xl'>Amenities</h1>
            <h1 className='w-[85px] h-[3px] bg-red-600'></h1>
        ...
        <div className='bg-white w-2/5 m-10'>
            <div className='1box p-8 border-[1px] border-gray-400 '>
               <h1 className='font-semibold text-2xl text-gray-600' >Activity On This Property</h1>
               <h1 className='w-[275px] h-[3px] bg-red-600'></h1>
               <div className='flex justify-between mt-10'>
                 <p className='border-[1px] px-7'>x<h1>Unique views</h1></p>
                 <p className='border-[1px] px-7'>x<h1>Shortlists</h1></p>
                 <p className='border-[1px] px-7'>x<h1>Contacted</h1></p>
               </div>
            </div>
            <div className='2box p-5 mt-10 border-[1px] border-gray-500'>
              <h1 className='font-semibold text-2xl text-gray-600' >Similar Properties</h1>
              <h1 className='w-[225px] h-[3px] bg-red-600'></h1>
              <div>
                <div className='flex justify-between mt-10 mb-10'>
                  <img/>
                  <h1>1 BHK Flat for sale in Shastri Nagar</h1>
                  <h1>price Rs.60Lacs   Built Area 360 Sqft</h1>
                </div>
                <div className='flex justify-between mt-10 mb-10'>
                  <img/>
                  <h1>1 BHK Flat for sale in Shastri Nagar</h1>
              ...
              <button className='bg-green-600 px-32 py-2'>More 1 BHK Property for sale in Khar East</button>
            </div>
